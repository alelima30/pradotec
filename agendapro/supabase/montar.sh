#!/usr/bin/env bash
# Junta 01 a 07 no 00_tudo.sql, que é o arquivo para colar de uma vez
...
for f in 01_schema.sql 02_rls.sql 03_onboarding.sql 04_imagens.sql 05_agenda.sql 06_vitrine.sql 07_plataforma.sql; do
  {
    echo ''
    echo '-- ###########################################################################'
    echo "-- ## $f"
