#!/usr/bin/env bash
# Junta 01 + 02 + 03 no 00_tudo.sql, que é o arquivo para colar de uma vez
# no SQL Editor do Supabase. Rode isto sempre que mexer nos três.
set -euo pipefail
...
--
-- Gerado por supabase/montar.sh — não edite à mão; edite os três de origem.
--
...
for f in 01_schema.sql 02_rls.sql 03_onboarding.sql; do
  {
    echo ''
    echo '-- ###########################################################################'
    echo "-- ## $f"
