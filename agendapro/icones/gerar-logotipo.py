...
def montar(d1, d2, w1, w2, *, tinta, com_pilula):
  ...
  <defs>
    <linearGradient id="lg-g" x1="{w1:.0f}" y1="30" x2="{larg-40:.0f}" y2="150"
      ...
      <stop offset="0" stop-color="#F0247E"/>
      <stop offset=".45" stop-color="#C21C9A"/>
      <stop offset="1" stop-color="#6D1FD0"/>
    </linearGradient>
    <linearGradient id="lg-c" x1="60" y1="170" x2="{larg-90:.0f}" y2="150"
                    gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#F0247E"/><stop offset="1" stop-color="#5B1FD0"/>
    </linearGradient>
...
{f"""
  <g transform="translate({meio:.0f} 182)">
    <rect width="300" height="62" rx="31" fill="url(#lg-p)"/>
    <g transform="translate(36 16)" fill="none" stroke="#fff" stroke-width="3.4"
       stroke-linecap="round" stroke-linejoin="round">
      <rect x="1" y="4" width="30" height="26" rx="4"/>
      <path d="M1 12h30M9.5 1v6M22.5 1v6"/><path d="m10 21 5 5 9-10"/>
    </g>
